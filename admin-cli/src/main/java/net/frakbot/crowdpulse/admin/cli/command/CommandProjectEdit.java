 ...
 */
@Parameters(commandNames = CommandProjectEdit.COMMAND_NAME)
public class CommandProjectEdit extends Command {
    public static final String COMMAND_NAME = "project-edit";

    @Parameter(description = "The file containing the updated project configuration")
    private File file;
